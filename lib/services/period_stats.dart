...
class PeriodStats {
  ...
  /// شرح مختصر لطريقة الحساب يظهر في صفحة تفصيل اليوم.
  static const String companyRuleText =
      'الإضافة تُحسب بتاريخ إضافتها والإلغاء بتاريخ إلغائه (مثل المكاتب)، '
      'فالحركة التي أُضيفت ثم أُلغيت تُحسب إضافة وإلغاء معًا.';
}
